...
public class AvgPulseDoc {
	...
	public static AvgPulseDoc of(PulseProbe avgPulseProb) {
		return new AvgPulseDoc(avgPulseProb.patientId(), avgPulseProb.value(),
				Instant.ofEpochMilli(avgPulseProb.timestamp()).atZone(ZoneId.systemDefault()).toLocalDateTime());
	}
