...
public class EmailDataProviderImpl implements EmailDataProvider {
	...
	final RestTemplate restTemplate; // для связи с синхронным сервисом
	...
	public EmailNotificationData getData(long patientId) {
		...
		try {
			ResponseEntity<EmailNotificationData> responseEntity = restTemplate.exchange(url, HttpMethod.GET, null,
